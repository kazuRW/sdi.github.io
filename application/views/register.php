		...
		<div class="account-form-inner">
			<div class="account-container">
				<div class="heading-bx left">
					<h2 class="title-head">Registrasi <span>Sekarang</span></h2>
				...
				<form class="contact-bx">
					<div class="row placeani">
						...
						<div class="col-lg-12 m-b30">
							<button name="submit" type="submit" value="Submit" class="btn button-md">Registrasi</button>
						</div>
						<div class="col-lg-12">
							<h6>Registrasi menggunakan media lain</h6>
							<div class="d-flex">
